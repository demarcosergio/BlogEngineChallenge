...
namespace BlogEngineSergioDemarco.Migrations
{
    public partial class SeedRoles : Migration
    {
        ...
        private string PostId = Guid.NewGuid().ToString();
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            SeedPosts(migrationBuilder);
        }

        private void SeedPosts(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@$"INSERT INTO [dbo].[Posts] ([Id],[Name])
            VALUES ('{PostId}', 'First Post');");
        }

        private void SeedRolesSQL(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@$"INSERT INTO [dbo].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
            VALUES ('{AdminRoleId}', 'Administrator', 'ADMINISTRATOR', 1);");
            migrationBuilder.Sql(@$"INSERT INTO [dbo].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
            VALUES ('{ManagerRoleId}', 'Manager', 'MANAGER', 2);");
            migrationBuilder.Sql(@$"INSERT INTO [dbo].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
            VALUES ('{UserRoleId}', 'User', 'USER', 3);");
        }
